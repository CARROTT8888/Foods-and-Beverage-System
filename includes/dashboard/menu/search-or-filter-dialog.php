                        ...
                        <div class="flex flex-col gap-3 my-2">
                            ...
                            <div class="inline-flex items-center justify-betweena">
                                ...
                                <label class="cursor-pointer ml-2 font-sans antialiased text-sm text-green-600 flex-1"
                                    for="Visible">Available</label>
                                <span
                                    class="font-sans antialiased text-sm text-green-600 ml-6"><?php echo $totalStatusAvailableFromFood; ?></span>
                            </div>
                            <div class="inline-flex items-center justify-between">
                                <label class="flex items-center cursor-pointer relative" for="Sold Out">
                                    <input type="checkbox" id="Sold Out" name="status[]" value="Sold Out"
                                        <?= in_array('Sold Out', $selectedStatuses) ? 'checked' : '' ?>
                                        class="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded shadow hover:shadow-md border border-slate-300 checked:bg-primary checked:border-secondary" />
                                    <span
                                        class="absolute text-white opacity-0 peer-checked:opacity-100 top-4.5 left-4.5 transform -translate-x-1/2 -translate-y-1/2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 20 20"
                                ...
                                <label class="cursor-pointer ml-2 font-sans antialiased text-sm text-red-600 flex-1"
                                    for="Sold Out">Sold Out</label>
                                <span
                                    class="font-sans antialiased text-sm text-red-600 ml-6"><?php echo $totalStatusSoldout; ?></span>
                            </div>

                            <div class="inline-flex items-center justify-between">
                                <label class="flex items-center cursor-pointer relative" for="Discontinued">
                                    <input type="checkbox" id="Discontinued" name="status[]" value="Discontinued"
                                        <?= in_array('Discontinued', $selectedStatuses) ? 'checked' : '' ?>
                                        class="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded shadow hover:shadow-md border border-slate-300 checked:bg-primary checked:border-secondary" />
                                    <span
                                        class="absolute text-white opacity-0 peer-checked:opacity-100 top-4.5 left-4.5 transform -translate-x-1/2 -translate-y-1/2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 20 20"
                                ...
                                <span
                                    class="font-sans antialiased text-sm text-slate-600 ml-6"><?php echo $totalStatusDiscontinued; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
