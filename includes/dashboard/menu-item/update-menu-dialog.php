    ...
    <div class="bg-white rounded-xl shadow-2xl shadow-slate-950/5 border border-slate-200 scale-95 w-115 p-5 ">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="overflow-y-scroll h-[500px]">
                ...
                <div class="mt-6">
                    <label for="image" class="block text-sm font-medium text-foreground mb-1 text-start">
                        Upload Image
                    </label>

                    <input type="hidden" name="old_image"
                        value="<?php echo htmlspecialchars($food ? $food['image'] : ''); ?>">

                    <input type="file" class="w-full text-center flex justify-center" name="image" id="updateImageFile"
                        accept="image/png, image/jpeg, image/gif">

                    <img id="previewImage"
                        src="<?php echo !empty($food['image'])
                            ? '/Foods-and-Beverage-System/uploads/menus/' . htmlspecialchars($food['image'])
                            : 'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.sopandai.com%2Fwp-content%2Fuploads%2F2023%2F01%2FMMU.png.webp&f=1&nofb=1'; ?>"
                        class="mt-4 w-full h-40 object-cover rounded-lg border">
