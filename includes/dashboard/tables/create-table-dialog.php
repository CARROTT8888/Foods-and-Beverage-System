<div class="fixed inset-0 bg-slate-950/50 flex justify-center items-center opacity-0 pointer-events-none transition-opacity duration-300 ease-out z-9999"  onclick="event.target === this && null"
    id="createBranchDialog" aria-hidden="true">
