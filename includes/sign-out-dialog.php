    ...
    <div class="bg-white rounded-xl shadow-2xl shadow-slate-950/5 border border-slate-200 scale-95 w-115 p-5 ">
        <form method="POST">
            <div class="flex justify-between mb-4">
                <h1 class="text-lg text-slate-800 font-semibold">Signing Out</h1>
            ...
            <div class="text-slate-600 text-start">Are you sure you want to sign out? your session data including orders
                won't
                appear again once you sign out.</div>
            <div class="mt-6">
                <div class="flex justify-end gap-2">
                    <button onclick="closeSignoutDialog()" type="button"
                    ...
                    <a href="sign-out.php">
                        <button type="button"
                            class="rounded-md border bg-destructive px-4 py-2 text-center text-sm font-medium border-red-500 text-red-50 hover:bg-red-400 hover:border-red-400">Sign
                            Out</button>
                    </a>
                </div>
